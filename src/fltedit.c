...
void print_hostparam_line(struct filterent *fe, int idx,
                          WINDOW * win, int attr)
{
    ...
    do {
        ...
        case 13:
            if (fe != NULL) {
                ...
                gethostparams(&(fe->hp), fe->hp.s_fqdn, fe->hp.s_mask,
                              s_portstr1, s_portstr2, fe->hp.d_fqdn,
                              fe->hp.d_mask, d_portstr1, d_portstr2,
                              inexstr, matchop, &gh_aborted);
